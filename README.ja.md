...
| **G** | フロントエンド UI の国際化(i18n: `en` / `zh-TW` / `zh-CN` / `ja`)+ アカウントメニューの言語切り替え | 🔜 計画中(SRS v2.31) |
...
- **[システム要求仕様書(SRS)](docs/superpowers/specs/2026-05-17-paperhub-srs.md)** — 信頼できるアーキテクチャ、スキーマ、スコープ、受け入れ基準(**v2.31** まで提供)。
